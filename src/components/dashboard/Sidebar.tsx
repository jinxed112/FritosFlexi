...
export default function DashboardSidebar() {
  ...
  return (
    <>
      {/* Mobile top bar — inline, not fixed */}
      <div className="lg:hidden flex items-center justify-between bg-gray-900 text-white px-4 py-2.5 flex-shrink-0">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-orange-400 to-red-500 flex items-center justify-center text-white font-black text-[10px] flex-shrink-0">
            F
          </div>
          <span className="font-bold text-sm tracking-tight">
            FritOS <span className="text-orange-400">Flexi</span>
